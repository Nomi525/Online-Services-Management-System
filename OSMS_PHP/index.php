...
<body>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner2.jpeg);">
    <div class="myclass mainHeading text-center">
      <h1 class="text-uppercase text-warning font-weight-bold mb-2">Welcome to OSMS</h1>
